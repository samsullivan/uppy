...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var _request = /* @__PURE__ */ _classPrivateFieldLooseKey7("request");
  ...
  var RequestClient = class {
    ...
    async preflight(path) {
      ...
      const promise = (async () => {
        try {
          const response = await fetch(_classPrivateFieldLooseBase7(this, _getUrl)[_getUrl](path), {
            method: "OPTIONS"
          });
    ...
    async get(path, options) {
      ...
      return _classPrivateFieldLooseBase7(this, _request)[_request]({
        ...options,
        path
      });
    }
  ...
  async function _request2(_ref3) {
    ...
    try {
      ...
      const response = await fetchWithNetworkError(_classPrivateFieldLooseBase7(this, _getUrl)[_getUrl](path), {
        method,
        signal,
        headers,
      ...
      if (err != null && err.isAuthError)
        throw err;
      throw new ErrorWithCause_default(`Could not ${method} ${_classPrivateFieldLooseBase7(this, _getUrl)[_getUrl](path)}`, {
        cause: err
      });
    }
  }
  ...
  async function getAssemblyOptions(file, options) {
    const assemblyOptions = typeof options.assemblyOptions === "function" ? await options.assemblyOptions(file, options) : options.assemblyOptions;
  ...
  var _assemblyIDs = /* @__PURE__ */ _classPrivateFieldLooseKey13("assemblyIDs");
  var _reject = /* @__PURE__ */ _classPrivateFieldLooseKey13("reject");
  var _remaining = /* @__PURE__ */ _classPrivateFieldLooseKey13("remaining");
  var _resolve = /* @__PURE__ */ _classPrivateFieldLooseKey13("resolve");
  var _uppy = /* @__PURE__ */ _classPrivateFieldLooseKey13("uppy");
  var _watching = /* @__PURE__ */ _classPrivateFieldLooseKey13("watching");
  var _onAssemblyComplete = /* @__PURE__ */ _classPrivateFieldLooseKey13("onAssemblyComplete");
  var _onAssemblyCancel = /* @__PURE__ */ _classPrivateFieldLooseKey13("onAssemblyCancel");
  var _onAssemblyError = /* @__PURE__ */ _classPrivateFieldLooseKey13("onAssemblyError");
  var _onImportError = /* @__PURE__ */ _classPrivateFieldLooseKey13("onImportError");
  var _checkAllComplete = /* @__PURE__ */ _classPrivateFieldLooseKey13("checkAllComplete");
  var _removeListeners = /* @__PURE__ */ _classPrivateFieldLooseKey13("removeListeners");
  var _addListeners3 = /* @__PURE__ */ _classPrivateFieldLooseKey13("addListeners");
  var TransloaditAssemblyWatcher = class extends import_component_emitter8.default {
    constructor(uppy, assemblyIDs) {
      ...
      Object.defineProperty(this, _onAssemblyComplete, {
        writable: true,
        value: (assembly) => {
          if (!_classPrivateFieldLooseBase13(this, _watching)[_watching](assembly.assembly_id)) {
            return;
          }
          _classPrivateFieldLooseBase13(this, _uppy)[_uppy].log(`[Transloadit] AssemblyWatcher: Got Assembly finish ${assembly.assembly_id}`);
          this.emit("assembly-complete", assembly.assembly_id);
          _classPrivateFieldLooseBase13(this, _checkAllComplete)[_checkAllComplete]();
        }
      });
      ...
      Object.defineProperty(this, _onAssemblyError, {
        ...
        value: (assembly, error) => {
          ...
          _classPrivateFieldLooseBase13(this, _uppy)[_uppy].log(`[Transloadit] AssemblyWatcher: Got Assembly error ${assembly.assembly_id}`);
          _classPrivateFieldLooseBase13(this, _uppy)[_uppy].log(error);
      ...
      Object.defineProperty(this, _onImportError, {
        ...
        value: (assembly, fileID, error) => {
          ...
          _classPrivateFieldLooseBase13(this, _onAssemblyError)[_onAssemblyError](assembly, error);
        }
      });
      _classPrivateFieldLooseBase13(this, _uppy)[_uppy] = uppy;
      _classPrivateFieldLooseBase13(this, _assemblyIDs)[_assemblyIDs] = assemblyIDs;
      _classPrivateFieldLooseBase13(this, _remaining)[_remaining] = assemblyIDs.length;
      this.promise = new Promise((resolve, reject) => {
        _classPrivateFieldLooseBase13(this, _resolve)[_resolve] = resolve;
        _classPrivateFieldLooseBase13(this, _reject)[_reject] = reject;
      });
      _classPrivateFieldLooseBase13(this, _addListeners3)[_addListeners3]();
    }
  };
  function _watching2(id20) {
    return _classPrivateFieldLooseBase13(this, _assemblyIDs)[_assemblyIDs].indexOf(id20) !== -1;
  }
  function _checkAllComplete2() {
    _classPrivateFieldLooseBase13(this, _remaining)[_remaining] -= 1;
    if (_classPrivateFieldLooseBase13(this, _remaining)[_remaining] === 0) {
      _classPrivateFieldLooseBase13(this, _removeListeners)[_removeListeners]();
      _classPrivateFieldLooseBase13(this, _resolve)[_resolve]();
    }
  }
  function _removeListeners2() {
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].off("transloadit:complete", _classPrivateFieldLooseBase13(this, _onAssemblyComplete)[_onAssemblyComplete]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].off("transloadit:assembly-cancel", _classPrivateFieldLooseBase13(this, _onAssemblyCancel)[_onAssemblyCancel]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].off("transloadit:assembly-error", _classPrivateFieldLooseBase13(this, _onAssemblyError)[_onAssemblyError]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].off("transloadit:import-error", _classPrivateFieldLooseBase13(this, _onImportError)[_onImportError]);
  }
  function _addListeners22() {
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].on("transloadit:complete", _classPrivateFieldLooseBase13(this, _onAssemblyComplete)[_onAssemblyComplete]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].on("transloadit:assembly-cancel", _classPrivateFieldLooseBase13(this, _onAssemblyCancel)[_onAssemblyCancel]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].on("transloadit:assembly-error", _classPrivateFieldLooseBase13(this, _onAssemblyError)[_onAssemblyError]);
    _classPrivateFieldLooseBase13(this, _uppy)[_uppy].on("transloadit:import-error", _classPrivateFieldLooseBase13(this, _onImportError)[_onImportError]);
  }
  ...
  var _rateLimitedQueue2 = /* @__PURE__ */ _classPrivateFieldLooseKey14("rateLimitedQueue");
  var _getClientVersion = /* @__PURE__ */ _classPrivateFieldLooseKey14("getClientVersion");
  var _attachAssemblyMetadata = /* @__PURE__ */ _classPrivateFieldLooseKey14("attachAssemblyMetadata");
  var _createAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey14("createAssembly");
  var _createAssemblyWatcher = /* @__PURE__ */ _classPrivateFieldLooseKey14("createAssemblyWatcher");
  var _shouldWaitAfterUpload = /* @__PURE__ */ _classPrivateFieldLooseKey14("shouldWaitAfterUpload");
  var _reserveFiles = /* @__PURE__ */ _classPrivateFieldLooseKey14("reserveFiles");
  var _onFileUploadURLAvailable = /* @__PURE__ */ _classPrivateFieldLooseKey14("onFileUploadURLAvailable");
  var _findFile = /* @__PURE__ */ _classPrivateFieldLooseKey14("findFile");
  var _onFileUploadComplete = /* @__PURE__ */ _classPrivateFieldLooseKey14("onFileUploadComplete");
  var _onResult = /* @__PURE__ */ _classPrivateFieldLooseKey14("onResult");
  var _onAssemblyFinished = /* @__PURE__ */ _classPrivateFieldLooseKey14("onAssemblyFinished");
  var _cancelAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey14("cancelAssembly");
  var _onCancelAll = /* @__PURE__ */ _classPrivateFieldLooseKey14("onCancelAll");
  var _getPersistentData = /* @__PURE__ */ _classPrivateFieldLooseKey14("getPersistentData");
  var _onRestored = /* @__PURE__ */ _classPrivateFieldLooseKey14("onRestored");
  var _connectAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey14("connectAssembly");
  var _prepareUpload = /* @__PURE__ */ _classPrivateFieldLooseKey14("prepareUpload");
  var _afterUpload = /* @__PURE__ */ _classPrivateFieldLooseKey14("afterUpload");
  var _closeAssemblyIfExists = /* @__PURE__ */ _classPrivateFieldLooseKey14("closeAssemblyIfExists");
  var _onError3 = /* @__PURE__ */ _classPrivateFieldLooseKey14("onError");
  var _onTusError = /* @__PURE__ */ _classPrivateFieldLooseKey14("onTusError");
  var Transloadit = class extends BasePlugin {
    constructor(uppy, opts) {
      ...
      Object.defineProperty(this, _onCancelAll, {
        ...
        value: async function(_temp) {
          ...
          try {
            ...
            await Promise.all(assemblies.map((assembly) => _classPrivateFieldLooseBase14(_this, _cancelAssembly)[_cancelAssembly](assembly)));
          } catch (err) {
            _this.uppy.log(err);
          }
        }
        ...
        value: (pluginData) => {
          ...
          const restoreState = (assemblies) => {
            ...
            for (const [id20, status] of Object.entries(assemblies)) {
              status.uploads.forEach((uploadedFile) => {
                const file = _classPrivateFieldLooseBase14(this, _findFile)[_findFile](uploadedFile);
          ...
          const restoreAssemblies = () => {
            ...
            Object.keys(uploadsAssemblies2).forEach((uploadID) => {
              ...
              _classPrivateFieldLooseBase14(this, _createAssemblyWatcher)[_createAssemblyWatcher](assemblyIDs, uploadID);
            });
            const allAssemblyIDs = Object.keys(assemblies);
            allAssemblyIDs.forEach((id20) => {
              const assembly = new Assembly_default(assemblies[id20], _classPrivateFieldLooseBase14(this, _rateLimitedQueue2)[_rateLimitedQueue2]);
              _classPrivateFieldLooseBase14(this, _connectAssembly)[_connectAssembly](assembly);
            });
          };
      ...
      Object.defineProperty(this, _prepareUpload, {
        ...
        value: (fileIDs, uploadID) => {
          ...
          const createAssembly = async (_ref) => {
            ...
            try {
              const assembly = await _classPrivateFieldLooseBase14(this, _createAssembly)[_createAssembly](fileIDs2, uploadID, options);
              if (this.opts.importFromUploadURLs) {
                await _classPrivateFieldLooseBase14(this, _reserveFiles)[_reserveFiles](assembly, fileIDs2);
              }
          ...
          return assemblyOptions.build().then((assemblies) => Promise.all(assemblies.map(createAssembly))).then((maybeCreatedAssemblies) => {
            ...
            _classPrivateFieldLooseBase14(this, _createAssemblyWatcher)[_createAssemblyWatcher](assemblyIDs, uploadID);
            return Promise.all(createdAssemblies.map((assembly) => _classPrivateFieldLooseBase14(this, _connectAssembly)[_connectAssembly](assembly)));
          }).catch((err) => {
        ...
        value: (fileIDs, uploadID) => {
          ...
          if (this.restored) {
            return this.restored.then(() => {
              return _classPrivateFieldLooseBase14(this, _afterUpload)[_afterUpload](filteredFileIDs, uploadID);
            });
          }
          ...
          if (!_classPrivateFieldLooseBase14(this, _shouldWaitAfterUpload)[_shouldWaitAfterUpload]()) {
      ...
      Object.defineProperty(this, _onError3, {
        ...
        value: function(err, uploadID) {
          ...
          const assemblyIDs = state.uploadsAssemblies[uploadID];
          assemblyIDs == null ? void 0 : assemblyIDs.forEach(_classPrivateFieldLooseBase14(_this, _closeAssemblyIfExists)[_closeAssemblyIfExists]);
      ...
      Object.defineProperty(this, _onTusError, {
        ...
        value: (file, err) => {
          ...
          _classPrivateFieldLooseBase14(this, _closeAssemblyIfExists)[_closeAssemblyIfExists](file == null ? void 0 : (_file$transloadit2 = file.transloadit) == null ? void 0 : _file$transloadit2.assembly);
      ...
      _classPrivateFieldLooseBase14(this, _rateLimitedQueue2)[_rateLimitedQueue2] = new RateLimitedQueue(this.opts.limit);
      this.i18nInit();
      const hasCustomAssemblyOptions = this.opts.assemblyOptions !== defaultOptions4.assemblyOptions;
      if (this.opts.params) {
      ...
      this.client = new Client({
        ...
        client: _classPrivateFieldLooseBase14(this, _getClientVersion)[_getClientVersion](),
        errorReporting: this.opts.errorReporting,
        rateLimitedQueue: _classPrivateFieldLooseBase14(this, _rateLimitedQueue2)[_rateLimitedQueue2]
      });
    ...
    install() {
      this.uppy.addPreProcessor(_classPrivateFieldLooseBase14(this, _prepareUpload)[_prepareUpload]);
      this.uppy.addPostProcessor(_classPrivateFieldLooseBase14(this, _afterUpload)[_afterUpload]);
      this.uppy.on("error", _classPrivateFieldLooseBase14(this, _onError3)[_onError3]);
      this.uppy.on("cancel-all", _classPrivateFieldLooseBase14(this, _onCancelAll)[_onCancelAll]);
      this.uppy.on("upload-error", _classPrivateFieldLooseBase14(this, _onTusError)[_onTusError]);
      if (this.opts.importFromUploadURLs) {
        this.uppy.on("upload-success", _classPrivateFieldLooseBase14(this, _onFileUploadURLAvailable)[_onFileUploadURLAvailable]);
      } else {
        this.uppy.use(Tus, {
          storeFingerprintForResuming: false,
      ...
      this.uppy.on("restore:get-data", _classPrivateFieldLooseBase14(this, _getPersistentData)[_getPersistentData]);
      this.uppy.on("restored", _classPrivateFieldLooseBase14(this, _onRestored)[_onRestored]);
      this.setPluginState({
        assemblies: {},
        uploadsAssemblies: {},
        files: {},
    ...
    uninstall() {
      this.uppy.removePreProcessor(_classPrivateFieldLooseBase14(this, _prepareUpload)[_prepareUpload]);
      this.uppy.removePostProcessor(_classPrivateFieldLooseBase14(this, _afterUpload)[_afterUpload]);
      this.uppy.off("error", _classPrivateFieldLooseBase14(this, _onError3)[_onError3]);
      if (this.opts.importFromUploadURLs) {
        this.uppy.off("upload-success", _classPrivateFieldLooseBase14(this, _onFileUploadURLAvailable)[_onFileUploadURLAvailable]);
      }
      const {
        capabilities
      } = this.uppy.getState();
  ...
  function _createAssembly2(fileIDs, uploadID, options) {
    ...
    return this.client.createAssembly({
      ...
      const assembly = new Assembly_default(newAssembly, _classPrivateFieldLooseBase14(this, _rateLimitedQueue2)[_rateLimitedQueue2]);
      const {
        status
      } = assembly;
      ...
      const updatedFiles = {};
      files.forEach((file) => {
        updatedFiles[file.id] = _classPrivateFieldLooseBase14(this, _attachAssemblyMetadata)[_attachAssemblyMetadata](file, status);
      });
      this.uppy.setState({
        files: {
          ...this.uppy.getState().files,
      ...
      const fileRemovedHandler = (fileRemoved, reason) => {
        if (reason === "cancel-all") {
          ...
          if (nbOfRemainingFiles === 0) {
            assembly.close();
            _classPrivateFieldLooseBase14(this, _cancelAssembly)[_cancelAssembly](newAssembly).catch(() => {
            });
            this.uppy.off(fileRemovedHandler);
          } else {
  ...
  function _connectAssembly2(assembly) {
    ...
    assembly.on("upload", (file) => {
      _classPrivateFieldLooseBase14(this, _onFileUploadComplete)[_onFileUploadComplete](id20, file);
    });
    ...
    if (this.opts.waitForEncoding) {
      assembly.on("result", (stepName, result) => {
        _classPrivateFieldLooseBase14(this, _onResult)[_onResult](id20, stepName, result);
      });
    }
    if (this.opts.waitForEncoding) {
      assembly.on("finished", () => {
        _classPrivateFieldLooseBase14(this, _onAssemblyFinished)[_onAssemblyFinished](assembly.status);
      });
  ...
  var _updateFilesAndFolders = /* @__PURE__ */ _classPrivateFieldLooseKey15("updateFilesAndFolders");
  var ProviderView = class extends View {
    ...
    getFolder(id20, name) {
      return this.sharedHandler.loaderWrapper(this.provider.list(id20), (res) => {
        ...
        _classPrivateFieldLooseBase15(this, _updateFilesAndFolders)[_updateFilesAndFolders](res, files, folders);
        this.plugin.setPluginState({
    ...
    async handleScroll(event) {
      ...
      if (this.shouldHandleScroll(event) && path) {
        ...
        try {
          ...
          _classPrivateFieldLooseBase15(this, _updateFilesAndFolders)[_updateFilesAndFolders](response, files, folders);
        } catch (error) {
  ...
  var _updateFilesAndInputMode = /* @__PURE__ */ _classPrivateFieldLooseKey16("updateFilesAndInputMode");
  var SearchProviderView = class extends View {
    ...
    search(query) {
      ...
      return this.sharedHandler.loaderWrapper(this.provider.search(query), (res) => {
        _classPrivateFieldLooseBase16(this, _updateFilesAndInputMode)[_updateFilesAndInputMode](res, []);
      }, this.handleError);
    }
    triggerSearchInput() {
      this.plugin.setPluginState({
    ...
    async handleScroll(event) {
      ...
      if (this.shouldHandleScroll(event) && query) {
        ...
        try {
          ...
          _classPrivateFieldLooseBase16(this, _updateFilesAndInputMode)[_updateFilesAndInputMode](response, files);
        } catch (error) {
          this.handleError(error);
        } finally {
          this.isHandlingScroll = false;
  ...
  var _handleKeyPress = /* @__PURE__ */ _classPrivateFieldLooseKey17("handleKeyPress");
  var _handleSubmit = /* @__PURE__ */ _classPrivateFieldLooseKey17("handleSubmit");
  var UrlUI = class extends d {
    constructor() {
      ...
      Object.defineProperty(this, _handleKeyPress, {
        ...
        value: (ev) => {
          if (ev.keyCode === 13) {
            _classPrivateFieldLooseBase17(this, _handleSubmit)[_handleSubmit]();
          }
        }
      });
    ...
    render() {
      ...
      return h("div", {
        ...
        onKeyUp: _classPrivateFieldLooseBase17(this, _handleKeyPress)[_handleKeyPress],
        ref: (input) => {
          this.input = input;
        },
        "data-uppy-super-focusable": true
        ...
        type: "button",
        onClick: _classPrivateFieldLooseBase17(this, _handleSubmit)[_handleSubmit]
      }, i18n("import")));
    }
  };
