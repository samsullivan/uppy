...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
  ...
  // ../packages/@uppy/drag-drop/lib/locale.js
  var locale_default2 = {
    strings: {
  ...
  // ../packages/@uppy/drag-drop/lib/DragDrop.js
  var packageJson3 = {
    "version": "3.0.1"
  };
  ...
  ProgressBar.VERSION = packageJson4.version;
  ...
  // src/examples/dragdrop/app.es6
  var onUploadSuccess = (elForUploadedFiles) => (file, response) => {
